...
//         console.log(encodeURIComponent(pageContext));
//         try {
//             // const response = await fetch(`/api/get_json_data.php?context=pageContext&page=hero`);
//             const response = await fetch(`/api/get_json_data.php?page=hero&context=${encodeURIComponent(pageContext)}`);
//             if (!response.ok) {
//                 throw new Error(`HTTP error! status: ${response.status}`);
//             }
//             console.log("3");
//             console.log(response);
//             console.log(response.type, response.body);
